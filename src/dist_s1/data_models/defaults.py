...
DEFAULT_LOW_CONFIDENCE_ALERT_THRESHOLD = 3.5
DEFAULT_HIGH_CONFIDENCE_ALERT_THRESHOLD = 5.5
...
DEFAULT_CONFIDENCE_UPPER_LIM = 32000
DEFAULT_CONFIRMATION_CONFIDENCE_THRESHOLD = 3**2 * 3.5  # 31.5
